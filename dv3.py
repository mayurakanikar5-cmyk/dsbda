...
sns.histplot(ax = axis[0,0], data = df, x='SL', multiple = 'dodge', kde = True)
sns.histplot(ax = axis[0,1], data = df, x='SW', multiple = 'dodge', kde = True)
sns.histplot(ax = axis[1,0], data = df, x='PL', multiple = 'dodge', kde = True)
sns.histplot(ax = axis[1,1], data = df, x='PW', multiple = 'dodge', kde = True)
plt.show()
fig, axis = plt.subplots(2,2)
